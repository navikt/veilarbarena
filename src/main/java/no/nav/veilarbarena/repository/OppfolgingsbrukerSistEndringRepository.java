...
public class OppfolgingsbrukerSistEndringRepository {
    ...
    public OppfolgingsbrukerSistEndret hentSistEndret(){
    ...
    @SneakyThrows
    private static OppfolgingsbrukerSistEndret mapOppfolgingsbrukerSistEndret(ResultSet rs, int row) {
        return new OppfolgingsbrukerSistEndret()
