...
import static no.nav.fo.veilarbarena.utils.NaiseratorUtils.getCredentials;
import static no.nav.fo.veilarbarena.utils.NaiseratorUtils.getDefaultSecretPath;
