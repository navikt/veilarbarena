...
public abstract class DbTest {
    ...
    protected static void initSpringContext(Class... classes) {
        List<Class> list = new ArrayList<>(asList(DatabaseConfig.class));
        list.addAll(asList(classes));

        setProperty(DatabaseConfig.VEILARBARENADB_URL, imMemoryUrl(), PUBLIC);
        setProperty(DatabaseConfig.VEILARBARENADB_USERNAME, "sa", PUBLIC);
        setProperty(DatabaseConfig.VEILARBARENADB_PASSWORD, "password", PUBLIC);
